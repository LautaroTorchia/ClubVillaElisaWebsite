<template>
  <footer
    class="footer text-center text-lg-start bg-light text-muted position-relative bottom-0 top-0 w-100"
  >
    <div
      class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom"
    >
      <div class="me-5 d-none d-lg-block">
        <span>Podes comunicarte con nosotros mediante:</span>
      </div>
      <div
      ...
      <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <p>Primer club histórico de la ciudad</p>
          </div>
          <div
            class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 d-flex justify-content-center"
          >
            <img
              alt="Logo del Club"
              src="/logo_club.svg"
