...
from src.core.board import list_active_disciplines, add_discipline, get_discipline, delete_discipline, update_discipline
...
def index_api():
    return jsonify(list(map(lambda x: x.to_dict(), list_active_disciplines())))

@discipline_blueprint.get("/")
def index():
    return render_template("discipline/list.html",disciplines=list_active_disciplines())
