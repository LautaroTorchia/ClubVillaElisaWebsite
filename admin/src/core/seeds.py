...
def populate():
    ...
    instructors=["Juan", "Pablo", "Maria", "Diana", "Horacio", "Pedro", "Kevin", "César"]
    days_and_hours=["Lunes 6:00pm - 8:00pm", "Martes 6:00pm - 8:00pm", "Miercoles 6:00pm - 8:00pm", "Lunes 2:00pm - 4:00pm", "Viernes 6:00pm - 8:00pm", "Sabado 6:00pm - 8:00pm", "Martes 4:00pm - 6:00pm", "Jueves 4:00pm - 6:00pm"]
    monthly_cost=[800, 800, 800, 600, 800, 600, 800, 600]

    dni=[22583743, 46583754, 20583743, 42583443, 28582754, 30583741, 14583743, 23683784]
    address=["Calle 1", "Calle 2", "Calle 3", "Calle 4", "Calle 5", "Calle 6", "Calle 7", "Calle 8"]
