...
class Associate(db.Model):
    ...
    DNI_type = Column(enum.Enum(DNIOptions,validate_string=True)) 
    gender = Column(enum.Enum(GenderOptions,validate_string=True))
    associate_number = Column(Integer,autoincrement=True,unique=True)
